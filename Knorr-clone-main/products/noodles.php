...
<body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item item-active" href="/Knor/knorr-clone-main/products/noodles.php">Noodles</a></li>
    ...
    <div class="container py-5">
        ...
        $query="SELECT * FROM products WHERE pcategory='Noodles'";
