...
<head>
    ...
    <title>Knorr - Chicken Corn Soup</title>
...
<body>
    ...
    <div class="prod d-flex m-5">
        <div class="prod-img w-15">
            <img src="/images/chicken-corn-soup.jpg" class="card-img-top" alt="ChattPata Noodles"
                style="width: 180px; margin-top: 7px; margin-bottom: -7px;">
            <div class="card-body">
                <hr style="margin-top: 5px; margin-bottom: 10px;">
                <p class="card-text" style="font-size: 17px; font-weight: bold; text-align: center;">Chicken Corn Soup
                </p>
            </div>
        </div>
        <div class="details">
            <h2>Knorr - Chicken Corn Soup</h2>
