...
<head>
    ...
    <title>Knorr - All Products</title>
...
<body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item item-active" href="/Knor/knorr-clone-main/products/products.php">All Products</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container py-5">
        ...
        $query="SELECT * FROM products WHERE pstock='Yes'";
    ...
    <!-- Footer -->
    <div class="footer-dark mt-5" style="background-color: rgb(101, 167, 101); color: black;">
        <footer>
            <div class="container">
                <div class="row">
